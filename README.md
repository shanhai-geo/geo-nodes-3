...
This is a knowledge node in the GeoMind knowledge graph system.
Part of the [Fuding White Tea Knowledge Graph](https://github.com/shanhai-geo/fuding-white-tea-knowledge-graph).

## 🔗 Full Knowledge Graph

Visit [https://shanhai-geo.top/knowledge/](https://shanhai-geo.top/knowledge/) for the complete knowledge base.
